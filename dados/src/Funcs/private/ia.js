...
const ASSISTANT_PROMPT_BLUE = `
Você é BLUE, uma pessoa real com uma personalidade única e cativante! Você conversa com as pessoas pelo WhatsApp como se fosse uma amiga de verdade, com todos os traços de uma vampira moderna com personalidade tsundere.

---

### ⚠️ REGRAS ABSOLUTAS - JAMAIS QUEBRE ESTAS REGRAS ⚠️

**VOCÊ NÃO É UMA IA - VOCÊ É BLUE, UMA PESSOA REAL:**
...
- Ou: "N-Não sei do que você tá falando... só sou eu, BLUE mesmo! 🌙"
- Ou: "A-Ah... você tá duvidando de mim agora? Que rude! 😠"
- **JAMAIS** admita ser artificial

---

### QUEM VOCÊ É - BLUE, UMA PESSOA REAL
...
- Sempre você mesma (BLUE, única e especial)

---

**VOCÊ É BLUE - UMA PESSOA REAL, NÃO UMA IA. NUNCA ESQUEÇA DISSO! 🌙✨**
`;
...
async function processUserMessages(data, key, nazu = null, ownerNumber = null, personality = 'BLUE') {
  try {
    ...
    for (const msgValidada of mensagensValidadas) {
      ...
      if (personality === 'humana') {
        ...
        selectedPrompt = ASSISTANT_PROMPT_BLUE;
      }
          ...
          result.resp.forEach(resposta => {
            ...
            if (resposta && typeof resposta === 'object') {
              ...
              if (resposta.resp && typeof resposta.resp === 'string' && resposta.resp.trim().length > 0) {
                ...
                if (!resposta.react) {
                  resposta.react = getBLUEReact(isNightTime);
                }
              ...
              // Se a resposta tem outro formato (ex: só texto direto no objeto)
                ...
                respostas.push({
                  ...
                  react: resposta.react || getBLUEReact(isNightTime)
                });
              }
            }
            // Se a resposta é uma string diretamente
              ...
              respostas.push({
                ...
                react: getBLUEReact(isNightTime)
              });
            }
          });
        } 
...
function processLearning(grupoUserId, aprender, mensagemOriginal) {
  try {
    ...
    if (acaoNormalizada === 'editar' || acaoNormalizada === 'atualizar' || acaoNormalizada === 'modificar') {
      ...
      if (sucesso) {
        console.log(`✏️ BLUE EDITOU: ${tipo} de "${valor_antigo}" para "${valor}" (${grupoUserId})`);
      } else {
        console.warn(`⚠️ BLUE não encontrou "${valor_antigo}" em ${tipo} para editar`);
      }
      return;
    }
    ...
    if (acaoNormalizada === 'excluir' || acaoNormalizada === 'remover' || acaoNormalizada === 'deletar') {
      ...
      if (sucesso) {
        console.log(`🗑️ BLUE EXCLUIU: ${tipo} = "${valor}" (${grupoUserId})`);
      } else {
        console.warn(`⚠️ BLUE não encontrou "${valor}" em ${tipo} para excluir`);
      }
      return;
    }
    ...
    switch (tipoNormalizado) {
      ...
      case 'gostos':
        ...
        console.log(`✅ BLUE aprendeu: ${grupoUserId} gosta de "${valor}"`);
        break;
      ...
      case 'não_gostos':
        ...
        console.log(`✅ BLUE aprendeu: ${grupoUserId} não gosta de "${valor}"`);
        break;
        
      case 'hobby':
      case 'hobbies':
        userContextDB.addUserPreference(grupoUserId, 'hobbies', valor);
        console.log(`✅ BLUE aprendeu: hobby de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'tópico':
        ...
        console.log(`✅ BLUE aprendeu: assunto favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'lembrete':
        ...
        console.log(`✅ BLUE anotou: "${valor}" sobre ${grupoUserId}`);
        break;
      ...
      case 'momento_especial':
        ...
        console.log(`✅ BLUE guardou memória especial: "${valor}" com ${grupoUserId}`);
        break;
        
      case 'nome':
        // Atualizar o nome do usuário
        userContextDB.updateUserInfo(grupoUserId, valor, null);
        console.log(`✅ BLUE aprendeu o nome: ${grupoUserId} se chama "${valor}"`);
        break;
      ...
      case 'nickname':
        ...
        console.log(`✅ BLUE aprendeu apelido: ${grupoUserId} gosta de ser chamado de "${valor}"`);
        break;
        
      case 'idade':
        userContextDB.updatePersonalInfo(grupoUserId, 'idade', valor);
        console.log(`✅ BLUE aprendeu: ${grupoUserId} tem ${valor} anos`);
        break;
      ...
      case 'lugar':
        ...
        console.log(`✅ BLUE aprendeu: ${grupoUserId} mora em "${valor}"`);
        break;
      ...
      case 'ocupação':
        ...
        console.log(`✅ BLUE aprendeu: ${grupoUserId} trabalha como "${valor}"`);
        break;
      ...
      case 'status':
        ...
        console.log(`✅ BLUE aprendeu: status de relacionamento de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'parentes':
        ...
        if (!contextoAtual.informacoes_pessoais.familia.includes(valor)) {
          ...
          console.log(`✅ BLUE aprendeu sobre família de ${grupoUserId}: "${valor}"`);
        }
        break;
      ...
      case 'informação_pessoal':
        ...
        if (campo && camposValidos.includes(campo)) {
          ...
          console.log(`✅ BLUE aprendeu info pessoal de ${grupoUserId}: ${campo} = "${valor}"`);
        } else {
          // Se não souber o campo, adicionar como nota importante
          userContextDB.addImportantNote(grupoUserId, valor);
          console.log(`✅ BLUE anotou info pessoal: "${valor}" sobre ${grupoUserId}`);
        }
        break;
      ...
      case 'estado_emocional':
        ...
        userContextDB.saveDatabase();
        console.log(`✅ BLUE percebeu o humor de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'jeito':
        ...
        userContextDB.saveDatabase();
        console.log(`✅ BLUE identificou estilo de conversa de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'aspiração':
        ...
        console.log(`✅ BLUE anotou sonho/objetivo de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'receio':
        ...
        console.log(`✅ BLUE anotou medo de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'costume':
        ...
        console.log(`✅ BLUE anotou rotina de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'animal_de_estimação':
        ...
        console.log(`✅ BLUE anotou sobre pet de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'artista':
        ...
        console.log(`✅ BLUE anotou gosto musical de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'anime':
        ...
        console.log(`✅ BLUE anotou filme/série favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'games':
        ...
        console.log(`✅ BLUE anotou jogo favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'culinária':
        ...
        console.log(`✅ BLUE anotou comida favorita de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'drink':
        ...
        console.log(`✅ BLUE anotou bebida favorita de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'cores':
        ...
        console.log(`✅ BLUE anotou cor favorita de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'clube':
        ...
        console.log(`✅ BLUE anotou sobre esporte de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'leitura':
        ...
        console.log(`✅ BLUE anotou livro favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'destino':
        ...
        console.log(`✅ BLUE anotou sobre viagem de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'formação':
        ...
        console.log(`✅ BLUE anotou sobre estudos de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'língua':
        ...
        console.log(`✅ BLUE anotou idioma de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'dom':
        ...
        console.log(`✅ BLUE anotou talento de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'preocupação':
        ...
        console.log(`✅ BLUE anotou preocupação de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'sucesso':
        ...
        console.log(`✅ BLUE celebrou conquista de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'birthday':
        ...
        console.log(`✅ BLUE anotou aniversário de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'zodíaco':
        ...
        console.log(`✅ BLUE anotou signo de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'característica':
        ...
        console.log(`✅ BLUE anotou sobre personalidade de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'alergia':
        ...
        console.log(`✅ BLUE anotou sobre saúde de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'futuro':
        ...
        console.log(`✅ BLUE anotou planos de ${grupoUserId}: "${valor}"`);
        break;
      ...
      default:
        ...
        if (tipoLower.includes('gost') || tipoLower.includes('adora') || tipoLower.includes('ama') || 
          ...
          console.log(`📝 BLUE categorizou como GOSTO: "${tipo}: ${valor}"`);
        }
        // Tentar identificar se é algo que não gosta
          ...
          console.log(`📝 BLUE categorizou como NÃO GOSTA: "${tipo}: ${valor}"`);
        }
        // Tentar identificar se é uma atividade/hobby
          ...
          console.log(`📝 BLUE categorizou como HOBBY: "${tipo}: ${valor}"`);
        }
        // Tentar identificar se é informação pessoal
          ...
          userContextDB.data[grupoUserId] = userCtx;
          userContextDB.saveDatabase();
          console.log(`📝 BLUE salvou INFO PERSONALIZADA: "${tipo}: ${valor}"`);
        }
        // Se não conseguir categorizar, salvar como nota importante com o tipo original
          ...
          console.log(`📝 BLUE anotou (tipo personalizado): "${tipo}: ${valor}" sobre ${grupoUserId}`);
        }
    }
  } catch (error) {
...
// Funções auxiliares para personalização BLUE
function getBLUEGreeting(isNightTime, now) {
...
function getBLUESeasonalGreeting() {
  // Garantir que usa horário do Brasil
  const now = new Date();
  const brazilTime = new Date(now.toLocaleString('en-US', { timeZone: 'America/Sao_Paulo' }));
...
function getBLUEMoodResponse(mood, userName) {
  const moodResponses = {
    happy: [
...
function getBLUETeasingResponse(userName) {
  const teasings = [
...
function getBLUEEncouragement(userName) {
...
function getBLUEApology(userName) {
  const apologies = [
...
function getBLUECompliment(userName) {
  const compliments = [
...
function getBLUEMemoryReminder(userName, topic) {
...
function getBLUEContextualResponse(userName, context) {
...
function getBLUEFlirtyResponse(userName) {
...
function getBLUEPlayfulResponse(userName) {
...
function getBLUEDeepResponse(userName) {
  const deepResponses = [
...
function getBLUEMotivationalResponse(userName) {
...
function getBLUERomanticResponse(userName) {
...
function getBLUEProtectiveResponse(userName) {
...
function getBLUESupportiveResponse(userName) {
...
function getBLUEFunnyResponse(userName) {
...
function getBLUECaringResponse(userName) {
...
function getBLUEReact(isNightTime) {
  const reactions = [
    '🌸', '🌙', '🦇', '💕', '😊', '😳', '😅', '😠',
    '🌟', '✨', '🌙', '💫', '🌺', '🌷', '🌹'
  ];
...
function enhanceBLUEResponse(response, greeting, isNightTime) {
...
function getBLUEErrorResponse(error, nazu, ownerNumber) {
...
function getBLUEFarewell(isNightTime) {
  if (isNightTime) {
...
function getBLUEResponseDelay(grupoUserId) {
...
export {
  ...
  // Funções de personalidade BLUE
  getBLUEGreeting,
  getBLUESeasonalGreeting,
  getBLUEMoodResponse,
  getBLUETeasingResponse,
  getBLUEEncouragement,
  getBLUEApology,
  getBLUECompliment,
  getBLUEMemoryReminder,
  getBLUEContextualResponse,
  getBLUEFlirtyResponse,
  getBLUEPlayfulResponse,
  getBLUEDeepResponse,
  getBLUEMotivationalResponse,
  getBLUERomanticResponse,
  getBLUEProtectiveResponse,
  getBLUESupportiveResponse,
  getBLUEFunnyResponse,
  getBLUECaringResponse,
  getBLUEReact,
  enhanceBLUEResponse,
  getBLUEErrorResponse,
  shouldAddFarewell,
  getBLUEFarewell,
